...
## Project Structure
    ...
    ├── on_demand_care_temp_38273  # Django project configurations
...
1. Clone this repo and `cd on_demand_care_temp_38273`
...
2. Clone this repo and `cd on_demand_care_temp_38273`
