"""
Django settings for on_demand_care_temp_38273 project.
...
ROOT_URLCONF = 'on_demand_care_temp_38273.urls'
...
WSGI_APPLICATION = 'on_demand_care_temp_38273.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "on_demand_care_temp_38273 API",
    "DESCRIPTION": "API documentation for on_demand_care_temp_38273 App",
    "VERSION": "v1",
}
